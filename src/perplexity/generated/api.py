...
class ChatCompletionsCompletionCreateParamsNonStreaming(ApiChatCompletionsRequestInput):
    stream: Optional[Literal[False]] = None


class ChatCompletionsCompletionCreateParamsStreaming(ApiChatCompletionsRequestInput):
    stream: Literal[True]
...
class ResponsesResponseCreateParamsNonStreaming(ResponsesRequestInput):
    stream: Literal[False] = False


class ResponsesResponseCreateParamsStreaming(ResponsesRequestInput):
    stream: Literal[True]
